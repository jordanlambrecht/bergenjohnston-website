  ...
  return (
    <>
      <NextSeo
        ...
        description={`Hi, I'm Bergen Johnston, a Professional Something or Another in Lincoln, Nebraska.`}
      ...
      <Section id='landing' className={""}>
        <div className='h-full flex justify-center lg:flex-row gap-x-24 gap-y-16'>
          <div className='self-center prose prose-stone  font-body'>
            <h1 className='prose prose-gray text-4xl font-semibold opacity-75 tracking-wide'>
